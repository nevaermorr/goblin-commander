...
public partial class GameEntity {
    ...
    public void AddDamage(float newValue, GameEntity newOrigin, GameEntity newTarget) {
    ...
    public void ReplaceDamage(float newValue, GameEntity newOrigin, GameEntity newTarget) {
        var index = GameComponentsLookup.Damage;
        var component = CreateComponent<DamageComponent>(index);
        component.Value = newValue;
        component.Origin = newOrigin;
